    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] bg-parchment border-rule/60 rounded-sm p-8">
        <DialogHeader className="mb-6">
          ...
          <DialogTitle className="text-3xl font-display text-ink">Amend Records</DialogTitle>
          <DialogDescription className="font-body italic text-sepia">
            Update the title and historical context of this lineage.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="pt-4 flex justify-end gap-3">
            ...
            >
              {pending ? 'Amending…' : 'Update Records'}
            </Button>
          </div>
        </form>
      </DialogContent>
