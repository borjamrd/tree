...
export default async function Home() {
  ...
  const steps = [
    { num: '01', title: t('howItWorks.steps.0.title'), body: t('howItWorks.steps.0.body') },
    { num: '02', title: t('howItWorks.steps.1.title'), body: t('howItWorks.steps.1.body') },
    { num: '03', title: t('howItWorks.steps.2.title'), body: t('howItWorks.steps.2.body') },
  ]
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-[var(--parchment)]">
      {/* Grain overlay */}
      <svg
        className="pointer-events-none fixed inset-0 w-full h-full z-50 opacity-[0.03]"
        aria-hidden
      >
        <filter id="grain">
          <feTurbulence
      ...
      <section className="relative flex flex-col items-center justify-center px-8 py-24 text-center overflow-hidden min-h-[90vh]">
        ...
        >
          {t('hero.description')} <em>{t('hero.descriptionEm')}</em>
        </p>
      ...
      <section id="features" className="px-8 py-24 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {features.map(({ num, title, body, icon }) => (
      ...
      <section className="relative mx-8 mb-24 overflow-hidden border border-[var(--rule)]">
        ...
        >
          <svg
            ...
            className="text-[var(--ink)] opacity-[0.025]"
          >
...
function QuoteMark() {
  return (
    <svg width="40" height="32" viewBox="0 0 40 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M0 32V18.667C0 8.533 5.333 2.133 16 0L18.667 4C13.6 5.333 10.667 8.8 10.667 12.8H18.667V32H0ZM21.333 32V18.667C21.333 8.533 26.667 2.133 37.333 0L40 4C34.933 5.333 32 8.8 32 12.8H40V32H21.333Z"
        fill="var(--rule)"
      />
    </svg>
  )
...
function PersonCard({ x, y, name, years, gender = 'm' }: PersonCardProps) {
  ...
  return (
    <g>
      ...
      <text x={x + 38} y={y + 46} fontFamily="Georgia, serif" fontSize="7.5" fill="#7D6545">
        {years}
      </text>
    </g>
  )
