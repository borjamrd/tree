...
import { ArrowRight, Calendar, TreePine, Users } from 'lucide-react'
  ...
  return (
    <div className="min-h-full bg-parchment/50 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%237D6545' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12 md:py-20">
        ...
        {trees.length === 0 ? (
          <div className="animate-fade-up delay-150 border border-dashed border-rule rounded-3xl py-32 flex flex-col items-center justify-center text-center bg-parchment-mid/20">
            ...
            <p className="font-body text-sepia max-w-xs mx-auto mb-8">{t('emptyDescription')}</p>
          </div>
        ) : (
                  ...
                  <Link href={`/trees/${tree.id}`} className="block">
                    <div className="mb-6">
                      <div className="flex items-center gap-2 pr-12">
                        ...
                        {tree.isShared && (
                          <span className="flex items-center gap-1 text-[9px] font-medium uppercase tracking-widest text-sepia/60 border border-rule rounded-full px-2 py-0.5 shrink-0">
